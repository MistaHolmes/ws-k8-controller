...
For persistent WebSocket workloads evaluated in this study, CPU utilization is not a reliable proxy for connection demand, and within the stabilization-window configurations evaluated, parameter tuning alone doesn't fix it. These findings feed directly into the connection-aware autoscaling
...
To the best of our knowledge, this is one of the first empirical studies to systematically
...
%% ============================================================
\section{Empirical Evidence of HPA Failure Under the Evaluated Workload Characteristics}
\label{sec:problem}
%% ============================================================
...
- our results suggest that the problem is what gets measured, not how long the measurement gets held onto.

One takeaway from all this is that autoscaling for stateful, persistent-connection
workloads may require two things working together: a scaling signal built
