...
%% Springer Nature sn-jnl template — Math and Physical Sciences Numbered
...
\title[HPA Behavior Under Stateful WebSocket Workloads]{An Empirical Study of Kubernetes HPA Behavior for Stateful WebSocket Workloads}

\author*[1]{\fnm{Abhash} \sur{Behera}}\email{abhasbehera320@gmail.com}

\author[1]{\fnm{Aditya} \sur{Hota}}\email{adityahota99@gmail.com}

\author[1]{\fnm{Suprit Kumar} \sur{Naik}}\email{supritkumarnaik17@gmail.com}

\author[1]{\fnm{Ritesh Kumar} \sur{Singh}}\email{rihankumar2004@gmail.com}
\author[1]{\fnm{Rakesh Ranjan Kumar} \sur{}}\email{rakeshranjan@cgu-odisha.ac.in}
\author[1]{\fnm{Binita Kumari} \sur{}}\email{binita.kumari@cgu-odisha.ac.in}

\affil*[1]{\orgdiv{Department of Computer Science and Engineering},
\orgname{C V Raman Global University},
\orgaddress{\city{Bhubaneswar}, \postcode{752054}, \state{Odisha}, \country{India}}}

\abstract{Kubernetes' Horizontal Pod Autoscaler (HPA) scales deployments using a
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{figures/experiment-a-hpa/replicas.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{figures/experiment-b1-hpa-churn/multi_averaged.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{figures/tuning_results_loss.png}
