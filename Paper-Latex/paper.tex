...
C V Raman Global University, Bhubaneswar 752054, India
\and
Dr.\ Rakesh Kumar Ranjan (Supervisor) \at
Department of Computer Science and Engineering, \\
C V Raman Global University, Bhubaneswar 752054, India \\
\email{rakeshranjan.cdac@gmail.com}
}
...
\item \textbf{Systematic empirical evidence chain.} Through four progressive experiments (A, B1, B2-Instrumented, B3), we characterize and quantify the failure of CPU-based HPA for WebSocket workloads: from over-provisioning under cyclic load, to the measurement of peak reconnection storm rates (1,400~conn/s), to causal proof of permanent connection destruction via idle-connection scale-down.
