...
# ---------------------------------------------------
# Multi-run helper: if processed multi-run dir exists,
...
def compute_multi_timeseries(proc_dir, filename, resample_s=1.0):
    ...
    for r in runs:
        ...
        # choose value column heuristically
...
if multi_rep is not None:
    ...
    ax3.plot(grid, mean, color=color_rep, linewidth=1.5, alpha=0.8, label="Replicas")
